...
app.use(
  session({
    secret: "blorp", // You should specify a real secret here
    resave: true,
...
app.use((req, res, next) => {
  ...
  if (
    ...
    console.log("301 redirect due to no https");
...
app.get("/", (req, res) => {
  ...
  if (req.session.username) {
    console.log("redirecting to /reauth because req.session.username is set");
